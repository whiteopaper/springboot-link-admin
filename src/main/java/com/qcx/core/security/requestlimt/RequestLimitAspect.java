...
import com.qcx.core.redis.IRedis;
...
public class RequestLimitAspect {
	...
	/**
	 * 定义拦截规则：拦截com.springboot.code.api包下面的所有类中，有@RequestLimit Annotation注解的方法
	 * 。
	 */
	@Around("execution(* com.qcx.code.api..*(..)) "
			+ "and @annotation(com.qcx.core.security.requestlimt.RequestLimit)")
